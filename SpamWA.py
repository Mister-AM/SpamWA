...
class spam:
        ...
        def tokped(self):
                ...
                regist = requests.get('https://accounts.tokopedia.com/otp/c/page?otp_type=116&msisdn='+self.nomer+'&ld=https%3A%2F%2Faccount>
        ...
        def balaji(self):
                ...
                head={
                        ...
                        "Save-Data":"on",
                        "User-Agent":"Mozilla/5.0 (Linux; Android 8.1.0; vivo 1718) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.>
        ...
        def TokoTalk(self):
                ...
                head={
                        "User-Agent":"Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.130 Safari/537>
                        "content-type":"application/json;charset=UTF-8"
                }
...
def apakah():
        while True:
                ...
                if( lan == 'y' or lan == 'Y'):
                        ...
                        print ('JAN LUPA SUBS Mister AM')
                        time.sleep(4)
                        os.system('xdg-open https://youtube.com/channel/UCXk4vbvDl7i6dxWBtNdpx6w')
                        break
                else:
                        continue
def files():
...
def dark_format_0992():
        os.system('clear')
        print (C+'Subs YT'+W+' Mister_AM!'+C+' :v')
        time.sleep(2)
        os.system('xdg-open https://youtube.com/channel/UCXk4vbvDl7i6dxWBtNdpx6w')
        time.sleep(2)
        os.system('clear')
...
def dark():
        ...
        print ('')
def dark_exit():
        print (C+'Byee Jan Lupa Sub Mister AM')
        os.system('exit')
def jnspam():
        global jns
        dark_format_0992()
